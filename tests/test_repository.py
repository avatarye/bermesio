...
def test_repository_class():
    ...
    result = BlenderVenvManager.create_blender_venv(TESTDATA['blender_venv|0|blender_venv_path'])
    ...
    sub_repo_dir = repo.blender_addon_repo.path
    result = BlenderAddonManager.create_blender_addon(TESTDATA['blender_addon|zip|path'], repo_dir=sub_repo_dir)
